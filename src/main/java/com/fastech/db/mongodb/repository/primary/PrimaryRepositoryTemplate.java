 ...
 */
@Component
public class PrimaryRepositoryTemplate
{
    @Autowired
    ...
    public Long getSequenceId(String sequenceName){
        ...
        Sequence sequence = firstMongoTemplate.findAndModify(query, update, options, Sequence.class);
    ...
    public Map<String, Object> findById(String id)
    {
        ...
        DBCollection collection = firstMongoTemplate.getCollection("person");
        BasicDBObject jsonSql = new BasicDBObject();
...
//        person.setName("zhangsan");
        firstMongoTemplate.save(objectToSave);
